        ...
        <div className="flex gap-2">
          ...
          >
            ...
            <AgentCombobox
              ...
              // Why: this is a full-width form row (and shrinks to ~50% when the
              // Account selector joins it), so the combobox's default 260px min
              // would overflow the dialog column.
              allowNarrowTrigger
